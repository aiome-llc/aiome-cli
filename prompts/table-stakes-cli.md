...
* Claude Code
  ...
  * local repo: `~/src/claude-code`
  * docs: https://code.claude.com/docs/en/overview
* Codex CLI
  * repo: https://github.com/openai/codex
  * local repo: `~/src/codex`
  * docs: https://developers.openai.com/codex/cli/
* Gemini CLI
  * repo: https://github.com/google-gemini/gemini-cli
  * local repo: `~/src/gemini-cli`
...
Document your findings and create a plan in `plans/table-stakes.md`. Add a task list for implementation.
